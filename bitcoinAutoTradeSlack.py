...
def get_start_time(ticker):
    df = pyupbit.get_ohlcv(ticker, interval="minute240", count=True)
...
while i<11:
    try:
        ...
        if ma15 < current_price and target_price < current_price and MACD("MACD_oscillator") < 0 and RSI("RSI")<32 and current_price<bb("lbb"):
            krw = get_balance("KRW")
        ...
        elif ma15 > current_price and target_price > current_price and MACD("MACD_oscillator") > 0 and RSI("RSI")>65 and current_price>bb("ubb"):
            btc = get_balance("BTC")
            if btc > 0.00008:
                time.sleep(1800)
                if ma15 > current_price and target_price > current_price and MACD("MACD_oscillator") > 0 and RSI("RSI")>65 and current_price>bb("ubb"):
