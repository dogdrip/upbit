...
df = pyupbit.get_ohlcv("KRW-BTT",interval="minute1", count=200)
...
while True:
    try:
        ...
        print("비트토렌트","MACD_oscillator",df["MACD_oscillator"],"RSI",df["RSI"],"ubb",df["ubb"],"lbb",df["lbb"])
        ...
        if buy == True:
            if krw > 5000:
                time.sleep(1800)
                if buy == True:
                    buy_result = upbit.buy_market_order("KRW-BTT", krw*0.25)
                    print("매수1번")
                    time.sleep(120)
                if buy == True:
                    buy_result = upbit.buy_market_order("KRW-BTT", krw*0.3333)
                    print("매수2번")
                    time.sleep(120)
                if buy == True:
                    buy_result = upbit.buy_market_order("KRW-BTT", krw*0.5)
                    print("매수3번")
                    time.sleep(120)
                if buy == True:
            ...
            if btt > 0.00008:
                ...
                if sell == True:
                    ...
                    time.sleep(200)
                if sell == True:
                    sell_result = upbit.sell_market_order("KRW-BTT", btt*0.3333)
                    print("매도2번")
                    time.sleep(300)
                if sell == True:
                    sell_result = upbit.sell_market_order("KRW-BTT", btt*0.5)
                    print("매도3번")
                    time.sleep(400)
                if sell == True:
